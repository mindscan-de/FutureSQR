...
/*  Created On : 24-Jun-2023 02:28:40 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
(
	...
	CONSTRAINT 'FK_ReviewDiscussions_CodeReviews' FOREIGN KEY ('reviewUuid') REFERENCES 'CodeReviews' ('reviewUuid') ON DELETE No Action ON UPDATE No Action,
...
CREATE INDEX 'IXFK_ReviewDiscussions_CodeReviews'
 ON 'ReviewDiscussions' ('reviewUuid' ASC)
;
